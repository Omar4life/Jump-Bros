...
class Player:
        ...
        for platform in platforms:
            if player_rect.colliderect(platform.rect):
                ...
                if min_overlap == overlap_top and self.vel_y >= 0:
                    ...
                    self.vel_y = 0
                    self.on_ground = True
                    self.double_jump_available = True  # Reset double jump on ground
    ...
    def respawn(self):
        ...
        if self.lives <= 0:
            ...
            self.vel_y = 0
            self.on_ground = False
            self.double_jump_available = True # Reset double jump on respawn
...
class Game:
    ...
    def setup_level(self, level_num):
        ...
        # Reset players to spawn positions and restore their state
        ...
        self.player1.double_jump_available = True
        ...
        self.player2.double_jump_available = True
